...
if __name__ == '__main__':
    ...
    for i in range(1, 101):
        random_str = string.join(random.sample(
            ['z', 'y', 'x', 'w', 'v', 'u', 't', 's', 'r', 'q', 'p', 'o', 'n', 'm', 'l', 'k', 'j', 'i', 'h', 'g', 'f',
             'e',
             'd', 'c', 'b', 'a'], 5)).replace(' ', '')
        SQL = SQL_refactor.SELECT_by_regInfo(random_str,)
    ...
    # SQL_refactor.SELECT_by_domain("google.com")
    # SQL_refactor.SELECT_by_regInfo("houjie")
